                ...
                SliverToBoxAdapter(
                  child: _TopGlassHeader(
                    title: state.maybeWhen(
                      loaded:
                          (pricing, _, __) =>
                              pricing == null ? '' : _t(context, pricing.title),
                      orElse: () => 'Pricing',
                    ),
                                    ...
                                    for (int i = 0; i < p.plans.length; i++)
                                      SizedBox(
                                        ...
                                        child: _PlanCard(
                                              ...
                                              onTap: () {
                                                print("==============>${(p.plans[i].ctaTarget)}");
                                                context.go(
                                                  '/checkout?plan=${Uri.encodeComponent(p.plans[i].ctaTarget)}',
                                                );
                                              },
                                            )
                                            .animate()
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: cs.primary.withOpacity(highlight ? 0.30 : 0.20),
        ),
      ),
      child: Text(
        text,
